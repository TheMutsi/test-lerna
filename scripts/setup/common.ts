...
const appIDQuestion = (platform: Platform) => ({name: `emb${platform}AppID`, message: `What is your ${platform} Embrace App ID? (5-character value)`});
...
export const iosAppID = {
    ...
    fetch: () => {
        ...
        return asker.ask(question).then((answers: Answer) => answers[question.name]);
    },
};
